...
export class AsaasService {
    ...
    async updateSubscription(asaasSubscriptionId: string, data: {
        value?: number;
        cycle?: 'MONTHLY' | 'YEARLY';
        nextDueDate?: string;
    }) {
    ...
    async getPixQrCode(asaasPaymentId: string): Promise<{ encodedImage: string; payload: string; expirationDate: string }> {
