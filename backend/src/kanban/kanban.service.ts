...
export class KanbanService {
    ...
    async updateDeal(workspaceId: string, dealId: string, data: any, userId?: string) {
    ...
    async moveDeal(workspaceId: string, dealId: string, targetColumnId: string, newOrder: number, userId?: string) {
        const oldDeal = await this.prisma.deal.findUnique({ where: { id: dealId } });
        const deal = await this.prisma.deal.update({
            where: { id: dealId, workspaceId },
            data: {
    ...
    async updateColumn(workspaceId: string, columnId: string, data: any, userId?: string) {
